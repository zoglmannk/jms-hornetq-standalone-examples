...
/**
 * You should see the following console output, which shows that the buffer has been disabled

removing all messages from queue before experiment
Received message: this is the 1st message
Sleeping for 5 seconds!
Begin Browsing Queue...
Browsing: this is the 2nd message
 ...
 *
 */
public class BrowserWithoutProblem {
	
	private static final String IP_ADDRESS = "10.0.0.124";
	
	private static final String QUEUE = "queue/DLQ";
	private static final String CONNECTION_FACTORY = "/StandaloneConnectionFactoryWithNoConsumerWindow";
	
	
	public static void main(String[] args) throws Exception {
		new BrowserWithoutProblem().exhibitProblem();
	}
